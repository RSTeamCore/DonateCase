...
dependencies {
    implementation(project(":donatecase-common"))
...
tasks.named<ShadowJar>("shadowJar") {
    ...
    dependencies {
        include(dependency(":donatecase-api:"))
        include(dependency(":donatecase-common:"))
        include(dependency("org.bstats:"))
        include(dependency("org.jetbrains.kotlin:"))
    }

    relocate("org.bstats", "${project.group}.dc.rslibs.lib.bstats")
    relocate("org.jetbrains.kotlin", "${project.group}.dc.rslibs.lib.kotlin")
