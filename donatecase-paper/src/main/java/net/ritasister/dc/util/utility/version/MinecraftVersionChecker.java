package net.ritasister.dc.util.utility.version;

import net.ritasister.dc.DCBootstrap;
...
public class MinecraftVersionChecker {
    ...
    public MinecraftVersionChecker(DCBootstrap bootstrap) {
        this.bootstrap = bootstrap;
    }

    public boolean check(DonateCasePaperPlugin plugin) {
        ...
        if (isVersionSupported()) {
            ...
            plugin.getLogger().severe(String.format("""
                    ====================================================
                        ...
                        DonateCase only works on %s!
                        Please refer to this thread: https://www.spigotmc.org/resources/102109/
