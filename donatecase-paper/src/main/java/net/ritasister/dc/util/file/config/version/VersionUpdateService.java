...
public class VersionUpdateService {
    ...
    public void checkAndUpdate(@NotNull DonateCasePaperPlugin plugin, @NotNull ConfigType type, @NotNull File currentFile, @NotNull String resourcePath) {
    ...
    private void update(ConfigType type, @NotNull DonateCasePaperPlugin plugin, File file, String resourcePath) {
