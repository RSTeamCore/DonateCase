package net.ritasister.dc.util.utility.platform;
...
public class PlatformDetector {
    ...
    public String detectPlatform(@NotNull DonateCaseBootstrap bootstrap, Platform.@NotNull Type platformType) {
    ...
    private void logPlatformWarning(@NotNull DonateCaseBootstrap bootstrap, @NotNull Platform.Type platformType) {
