...
public class Tools
{
    public void launchFirework(final Location l) {
        ...
        fw.setMetadata("case", (MetadataValue)new FixedMetadataValue((Plugin)Main.plugin, (Object)"case"));
        fw.detonate();
    }
    ...
    public boolean hasLevelGroup(final Player player, String group) {
        ...
        if (Main.levelGroup.containsKey(this.getGroup(player))) {
            try {
                if (Main.levelGroup.get(group) <= Main.levelGroup.get(this.getGroup(player))) {
                    return false;
                }
            }
            catch (Exception ex) {}
    ...
    public String getGroup(final Player player) {
        try {
            return Main.permission.getPrimaryGroup(player).toLowerCase();
        }
    ...
    public void msg(final CommandSender s, final String msg) {
        this.msg_(s, String.valueOf(String.valueOf(String.valueOf(Main.lang.getString("Prefix")))) + msg);
    }
